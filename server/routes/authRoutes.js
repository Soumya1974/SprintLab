...
import { handleValidSignUp, handleValidLogin, handleValidEmail } from "../middlewares/authMiddlewares.js";
...
authRouter.post('/forgot-password', handleValidEmail, handleUserData);
