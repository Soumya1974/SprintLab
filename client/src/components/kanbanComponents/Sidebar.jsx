                            ...
                            <div className="relative pl-2">
                              {workspaces.map((workspace) => (
                                <button
                                  ...
                                  className="group relative flex w-full items-start gap-2 rounded-md py-2 px-2 text-left text-[13px] text-slate-700 transition-colors hover:bg-slate-100 before:absolute before:-left-2 before:top-1/2 before:w-2 before:h-px before:bg-slate-400"
                                >
                                  <span
                                  ...
                                  <span className="min-w-0 flex-1 whitespace-normal wrap-break-word font-medium leading-snug group-hover:text-slate-900">
