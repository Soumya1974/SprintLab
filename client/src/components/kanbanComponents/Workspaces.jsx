      ...
      {selectedWorkspace ? (
        ...
        <>
          <div className="flex items-center justify-between py-5 px-5">
            ...
            <button
              className="inline-flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white text-sm font-medium px-3.5 py-2 rounded-lg transition-all duration-150 hover:cursor-pointer"
          ...
          {isLoading ? (
            ...
            <div className="mx-5 flex flex-col items-center justify-center text-center bg-slate-50/60 border border-slate-200 rounded-2xl py-20 px-6 animate-fade-in-up [animation-delay:80ms]">
              ...
              <button
                className="inline-flex items-center gap-1.5 bg-blue-600 hover:bg-blue-700 active:scale-95 text-white text-sm font-medium px-4 py-2.5 rounded-lg transition-all duration-150 hover:cursor-pointer"
                onClick={() => setProjectForm(true)}
              >
                <Plus className="h-4 w-4" />
                Create Workspace
